namespace AttibutesAndReflection
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            DiscoverSystemString();

            DiscoverSystemReflection();
        ...
        private static void DiscoverSysteType()
        {
        ...
        private static void DiscoverSystemReflection()
        {
        ...
        private static void DiscoverSystemString()
        {
        ...
        private static void DiscoverReflection()
        {
